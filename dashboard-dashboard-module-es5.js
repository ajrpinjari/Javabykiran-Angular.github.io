    ...
    var EmployeedetailsComponent = /*#__PURE__*/function () {
      ...
      _createClass(EmployeedetailsComponent, [{
        ...
        value: function getDataFromBackend(id) {
          ...
          this.service.getEmplyoeeById(id).subscribe(function (response) {
            // console.log(response);
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function onradio(item) {
          this.isradioCheck = true; // console.log(item);
